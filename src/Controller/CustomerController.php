...
class CustomerController extends EntityController
{
     ...
     * The delete route.
     */
    public const ROUTE_DELETE = 'customer_delete';

    /**
     * The list route.
     */
    public const ROUTE_LIST = 'customer_list';

    /**
     * The edit template.
     */
    public const TEMPLATE_EDIT = 'customer/customer_edit.html.twig';
    ...
    protected function editItem(Request $request, array $parameters): Response
    {
        ...
        // $parameters['title'] = $item->isNew() ? 'customer.add.title' : 'customer.edit.title';
