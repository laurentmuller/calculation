...
class AbstractMarginTest extends TestCase
{
    ...
    {
        $margin = $this->getAbstractMargin(0.0, 10.0);
    ...
    {
        $margin = $this->getAbstractMargin(1.0, 10.0);
        self::assertSame(9.0, $margin->getDelta());
    }

    public function testMarginAmount(): void
    {
        $margin = $this->getAbstractMargin(0.0, 10.0, 2.5);
    ...
    private function getAbstractMargin(float $minimum = 0.0, float $maximum = 0.0, float $margin = 1.0): AbstractMargin
    {
